...
class ZoomPanVideoView @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0
) : VideoView(context, attrs, defStyleAttr), View.OnTouchListener {
    ...
    fun setOnTouchListener(v: View, event: MotionEvent, bitmap: Bitmap?) {
        this.bitmap = bitmap
        onTouch(v, event)
    }

    override fun onTouch(v: View, event: MotionEvent): Boolean {
        val view = v as VideoView
        (BitmapDrawable(resources, bitmap)).setAntiAlias(true)
